                ...
                <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
                    <div className="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
                        ...
                        <ul className="flex items-center space-x-3 mt-9">
                            ...
                            <li>
                                <Link href="https://www.facebook.com/celebiotolastik45/" target="_blank" title="Çelebi Oto Lastik - Facebook" className="flex items-center justify-center text-white transition-all duration-200 bg-[#1f2937] rounded-full w-7 h-7 hover:bg-red focus:bg-red">
                            ...
                            <li>
                                <Link href="https://www.instagram.com/celebijantlastikk/" target="_blank" title="Çelebi Oto Lastik - Instagram" className="flex items-center justify-center text-white transition-all duration-200 bg-[#1f2937] rounded-full w-7 h-7 hover:bg-red focus:bg-red">
                                    <svg className="w-4 h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
